				...
				<div class="zone-header-top zone clearfix">
					...
					<div class="header-top-left container-8">
						...
						<div class="user-links">
							<div class="login">
								<a href="#" id="login-link" class="login-link">Connexion</a>
								<form id="login-form" class="login-form">
									<input class="text-input-grey" type="text" placeholder="Nom d'utilisateur">
									<input class="text-input-grey" type="text" placeholder="Mot de passe">
									<a href="#" class="password-restore">Mot de passe oublié ?</a>
									<input class="button-2-green" type="submit" value="Connexion">
								</form>
							</div>
							<div class="register">
								<a href="#" id="register-link" class="register-link">Inscription</a>
								<!-- <form id="register-form" class="register-form">
									...
									<input class="button-2-green" type="submit" value="Register">
								</form> -->
							</div>
						</div>
					...
					<div class="main-menu-container container-24">
						...
						<div class="main-menu block">
							<ul id="sf-menu">
								...
								<li class="last">
									<a href="index-2.html">PURCHASE THIS THEME</a>
								</li>
								<li class="empty">
									<div></div>
								</li>
							...
							<form class="subscription-table">
								<div id="subscription-options">
									<div class="subscription-column">
										<div class="subscription-header">Step 1: <span class="text-green">Identify</span></div>
									...
									<div class="subscription-column">
										<div class="subscription-header">Step 2: <span class="text-green">Register</span></div>
										<div class="subscription-body">
											Login details: <br />
									...
									<div class="subscription-column">
										<div class="subscription-header">Step 3: <span class="text-green">Subscribe</span></div>
										<div class="subscription-body">
											Choose Package: <br />
											<div class="radio-buttons">
								...
								<div class="subscription-footer">
									<div class="subscription-background">
										<div class="subscription-button-wrapper">
											<input type="submit" class="button-green" value="SUBSCRIBE" name="subscribe" />
										</div>
									</div>
								</div>
							</form>
				...
				<div class="zone-footer zone clearfix">
					...
					<div class="footer-container container-24">
						...
						<div class="recent-posts block">
							...
							<ul>
								<li class="first">
									<a href="#" class="text-green">Lorem ipsum dolor sit amet</a>
								</li>
								<li>
									<a href="#" class="text-green">Proin nibh augue suscipit</a>
								</li>
								<li>
									<a href="#" class="text-green">Cras vel lorem</a>
								</li>
								<li class="last">
									<a href="#" class="text-green">Quisque semper justo at risus</a>
								</li>
							</ul>
						</div>
